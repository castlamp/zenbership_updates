...
return array(
	...
	"INSERT INTO `ppSD_login_announcement_regions` (`id`, `name`, `tag`, `display`) VALUES (1, 'Homepage', 'homepage', 5), (2, 'Member Dashboard', 'dashboard', 10), (3, 'News Page', 'news_homepage', 10);",
